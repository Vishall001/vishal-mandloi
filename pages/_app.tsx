  ...
  return (
    <>
      <Head>
        ...
        <meta name="title" content="Vishal Mandloi" />
        <meta
          name="description"
          content="Hi, I am Vishal Mandloi"
          key="description"
        />
        ...
        />
        <meta property="og:title" content="Vishal Mandloi" />
        <meta
        ...
        <meta
          ...
          content={`https://${process.env.NEXT_PUBLIC_VERCEL_URL}`}
        />
        <meta property="twitter:title" content="Vishal Mandloi" />
        <meta
